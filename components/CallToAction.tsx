    ...
    <section className="py-12 sm:py-20 bg-white dark:bg-dark-background">
      <div className="container mx-auto px-4">
        <motion.div
            ...
            className="bg-primary dark:bg-dark-card rounded-3xl p-10 sm:p-16 text-center"
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="w-full sm:w-auto bg-secondary text-primary-dark font-bold py-3 px-8 rounded-xl text-lg shadow-lg hover:bg-secondary-light transition-all duration-300"
            >
              {t('cta.button1')}
            </motion.button>
            <motion.button
