...
const Hero: React.FC<HeroProps> = ({ onStartClick }) => {
  ...
  return (
    <section id="home" className="py-16 sm:py-20 md:py-32 overflow-hidden animated-gradient dark:bg-accent-light">
      <div className="container mx-auto px-4 text-center">
        ...
        <motion.p
          ...
          className="text-base sm:text-lg md:text-xl text-primary max-w-3xl mx-auto mb-8 leading-relaxed"
        >
